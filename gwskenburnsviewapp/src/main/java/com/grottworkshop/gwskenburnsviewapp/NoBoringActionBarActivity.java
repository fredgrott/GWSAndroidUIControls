...
public class NoBoringActionBarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHeaderPicture.setImageResource(R.drawable.picture0);
        mHeaderPicture.setImageResource(R.drawable.picture1);
    ...
    private void setupListView() {
        ...
        mListView.setAdapter(new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, FAKES));
