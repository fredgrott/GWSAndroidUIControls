...
public class PanningViewAttacher implements ViewTreeObserver.OnGlobalLayoutListener {
     ...
     * This is automatically called if you are using {@link com.grottworkshop.gwspanningview.PanningView}.
     */
    public final void cleanup() {
        if (null != mImageView) {
            //TODO: api level 16 ViewTreeObserver.removeGlobalLayoutListener() is depreciated suppose to use ViewTreeObserver.removeOnGlobalLayoutListener
